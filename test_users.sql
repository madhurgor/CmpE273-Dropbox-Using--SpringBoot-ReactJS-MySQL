...
INSERT INTO `users` VALUES ('D P','Gor','d@g.c','$2a$10$Y2JhmTP217jv8hxq.ABXh.ODBpPhMN1WMMq.Y.ifP4BL7H4JTDLdC','HW','M.Sc','0','Reading','Joined Vanita Vishram in 2006','Music'),('D P','Gor','d@g.c1','$2a$10$xMhkS2siedo1gSRlOBSnjuNhl/C4AMA/uOaF25dBxb3Lez9DuKROO','HW','M.Sc B.Ed','0','Reading','Joined Vanita Vishram in 2006','Music '),('m','m','m@g.c','mmmmmm',NULL,NULL,NULL,NULL,NULL,NULL),('Madhur','Gor','m@g.c1','mmmmmm','Infosys','MS in SE','0000000000','Chess','NA','Reading'),('Madhur Pankajkumar','Gor','m@g.c2','mmmmmm',NULL,NULL,NULL,NULL,NULL,NULL),('P P','Gor','p@g.c','$2a$10$UEvf5rpTq00wQsvNQnA7Au9pE7r60VAOPsP7gWFtO0WVwnsrao9li','XYZ','BE','0','Reading','Join GEB in 2000','Engineering'),('P P','Gor','p@g.c1','$2a$10$uoyJ7NKpJomrEDV3mUBJ/eANh7lNDV8..p5Y1FCTNDrpxPAvOccuW','GSFC','BE in EE','0','Reading','Join GEB in 2000','Engineering');
...
-- Dump completed on 2017-12-11  2:05:46
