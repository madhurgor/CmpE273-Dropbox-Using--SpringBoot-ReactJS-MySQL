...
class Files1 extends Component {
  ...
  onDownload = (item) => {
      axios.get(`http://localhost:8080/users/download`,{params:{file:item,username:this.props.select.username,path:this.props.select.path}})
         .then((res) => {
           console.log(res);
  ...
  onShareFile = () => {
      axios.get(`http://localhost:8080/users/share`,{params:{file:fileShare,username:this.props.select.username,path:this.props.select.path,member:[document.getElementById('s1').value,document.getElementById('s2').value,document.getElementById('s3').value,document.getElementById('s4').value,document.getElementById('s5').value,]}})
         .then((res) => {
           //console.log(res);
           console.log('shared..');
  ...
  onDelete = (item) => {
    if(window.confirm('Delete File?')){
      axios.get(`http://localhost:8080/users/delete`,{params:{file:item,username:this.props.select.username,path:this.props.select.path}})
         .then((res) => {
           console.log('deleted..');
  ...
  onStar = (item) => {
      axios.get(`http://localhost:8080/users/star`,{params:{file:item,username:this.props.select.username,path:this.props.select.path}})
         .then((res) => {
           console.log('starred..');
  ...
  onOpen = (item) => {
    ...
    setTimeout(() => {
      axios.get(`http://localhost:8080/users/open_folder`,{params:{path:this.props.select.path,username:this.props.select.username}})
         .then((res) => {
           //console.log(res);
  ...
  onFilesUpload = () => {
    if(this.state.files.length>0){
      ...
      axios.post(`http://localhost:8080/users/filesF`, formData, {params:{'username':`${this.props.select.username}`,path:this.props.select.path}})
      .then(response => {
  ...
  onFolderCreate = () => {
    if(document.getElementById('foldername1').value !==''){
      axios.get(`http://localhost:8080/users/createfolder`,{params:{path:this.props.select.path,username:this.props.select.username,foldername:document.getElementById('foldername1').value}})
         .then((res) => {
  ...
  onFolderDelete = (item) => {
    if(window.confirm('Delete Folder?')){
      axios.get(`http://localhost:8080/users/delete_folder`,{params:{folder:item,path:this.props.select.path,username:this.props.select.username}})
         .then((res) => {
           //console.log(res);
