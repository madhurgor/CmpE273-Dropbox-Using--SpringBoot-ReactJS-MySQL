...
public class UserController {
    ...
    public @ResponseBody List<String> getAllUsers1(@RequestParam("path") String path) {
        System.out.println("this is path: "+path.equals(""));
        return fileServices.getFiles(path);
    }
